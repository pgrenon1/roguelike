...
class GameMap(libtcod.map.Map):
    def __init__(self, width, height, world, factory):
        ...
        self.ch = numpy.zeros((height, width), dtype=numpy.intc)
        self.fg = numpy.zeros((height, width), dtype='(3,)u1')
        self.bg = numpy.zeros((height, width), dtype='(3,)u1')
        self.create_level()
    ...
    def create_level(self):
        ...
        global noise
        noise = libtcod.noise_new(4, 1.0, 0.9)
        ...
        self.factory.instantiate_entity('tree', 20, 20)
