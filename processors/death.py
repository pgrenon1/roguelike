    ...
    def process_dnageneration(self, ent):
        ...
        if self.world.has_component(ent, c.GenerateDna):
            ...
            for component in current_components:
                if not isinstance(component, (c.Renderable, c.Position, c.Metadata, c.Stats, c.AiRandomAgitated, c.AiRandomCalm, c.AiPredator, c.Speed, c.GenerateDna, c.Decay, c.Dna)):
